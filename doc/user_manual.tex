...
It is necessary to provide the methods \verb+getCopy+, \verb+getIdCode+, \verb+f+, \verb+f1d+, \verb+f2d+ ,
\verb+f3d+ and highly recommended to provide \verb+fad+ (otherwise fad will use the other methods via virtual function calls -> slow).
