...
int main(){
   ...
   ffnn->getLayer(0)->getUnit(2)->setActivationFunction(ActivationFunctionManager::provideActivationFunction("lgs"));
   ffnn->getLayer(1)->getUnit(3)->setActivationFunction(ActivationFunctionManager::provideActivationFunction("gss"));
   ffnn->getLayer(2)->getUnit(1)->setActivationFunction(ActivationFunctionManager::provideActivationFunction("gss"));
   ffnn->getLayer(3)->getUnit(2)->setActivationFunction(ActivationFunctionManager::provideActivationFunction("gss"));
