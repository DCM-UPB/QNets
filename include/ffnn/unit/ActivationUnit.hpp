...
public:
    ...
    explicit ActivationUnit(ActivationFunctionInterface * actf = std_actf::provideActivationFunction()): _actf(actf) {if (_actf == nullptr) { throw std::invalid_argument("ActivationUnit(): Passed pointer 'actf' was NULL.");
}}
    ...
    // Setters
    void setActivationFunction(ActivationFunctionInterface * actf){delete _actf; if (actf != nullptr) { _actf=actf; } else { throw std::invalid_argument("ActivationUnit::setActivationFunction(): Passed pointer 'actf' was NULL.");
}}
