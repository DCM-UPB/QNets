...
public:
    ...
    explicit FedActivationUnit(ActivationFunctionInterface * actf = std_actf::provideActivationFunction(), FeederInterface * feeder = nullptr) : FedUnit(feeder), ActivationUnit(actf) {}
    explicit FedActivationUnit(const std::string &actf_id, FeederInterface * feeder = nullptr) : FedActivationUnit(std_actf::provideActivationFunction(actf_id), feeder) {}
    ...
    void setMemberParams(const std::string &memberTreeCode) override{FedUnit::setMemberParams(memberTreeCode); ActivationUnit::setMemberParams(memberTreeCode);}
