...
public:
    ...
    FeatureMapLayer(const int &nedmaps, const int &nepdmaps, const int &nidmaps, const int &nunits = -1);
    ...
    void setNMaps(const int &nedmaps, const int &nepdmaps, const int &nidmaps);
