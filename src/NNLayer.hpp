...
public:
   ...
   // Values to compute
   void addFirstDerivativeSubstrate(const int &nx0);  // add the first derivative substrate to all units
                                                      // nx0 is the number of units used as input, i.e.
                                                      // the number of derivatives that will be computed
   void addSecondDerivativeSubstrate(const int &nx0);  // add the second derivative substrate to all units
                                                      // nx0 is the number of units used as input, i.e.
                                                      // the number of derivatives that will be computed
   void addVariationalFirstDerivativeSubstrate(const int &nvp); // add the variational first derivative substrate
                                                                // to all units.
                                                                // nvp is the number of variational parameters in
                                                                // the NN
